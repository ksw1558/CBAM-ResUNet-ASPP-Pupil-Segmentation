...
from nets.ca_res_unet_v4 import CAResUnetV4
...
if __name__ == "__main__":
    ...
    model = CAResUnetV4(num_classes=num_classes, pretrained=pretrained, backbone=backbone).train()

    if model_path == "":
        print('No weights loaded.')
    else:
        print(f'Loading V3 weights: {model_path}')
    ...
    log_dir = os.path.join(save_dir, "loss_exp10_" + str(time_str))
    ...
    UnFreeze_flag = False
    print(f"Starting Training Loop: {Init_Epoch} to {UnFreeze_Epoch}")
