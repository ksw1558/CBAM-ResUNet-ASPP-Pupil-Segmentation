...
try:
    ...
    print("❌ 找不到 nets.deeplabv3_plus.DeepLabV3Plus")
    sys.exit(1)


def eval_deeplab_voc():
    print("=" * 60)
    print("🚀 评估 06_DeepLabV3+ 在 VOC 上的性能")
    print("=" * 60)

    # 2. 路径配置
    folder_name = "06_DeepLabV3_Exp"
    ...
    # DeepLabV3+ 推荐输入 512，若显存不足或训练时用的 256，请改为 256
    input_size = 512
